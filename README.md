...
The program prints a table with all the tasks’ information and calculates **average turnaround** and **average waiting times**.

---

## Author

- **Khaled Hrkouz** – main developer (wrote all the code)
